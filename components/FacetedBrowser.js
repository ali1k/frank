            ...
            if(this.props.FacetedBrowserStore.total){
                resourceDIV = <div className="ui segment">
                                <h3 className="ui header">
                                    Badges <span className="ui blue circular label">{this.addCommas(this.props.FacetedBrowserStore.total)}</span>
            ...
            return (
                <div className="ui page grid" ref="facetedBrowser">
                        <div className="ui stackable four wide column">
                            <Facet color="green" onCheck={this.handleOnCheck.bind(this, 1, 'uri', '')} key="master" maxHeight={500} minHeight={300} spec={{property: '', propertyURI: '', instances: properties}} config={{label: 'Facets'}} graphName={this.props.FacetedBrowserStore.graphName}/>
                        </div>
                        {facetsDIV}
